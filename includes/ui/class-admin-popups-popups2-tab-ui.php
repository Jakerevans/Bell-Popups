<?php
/**
 * BellPopup_Settings_Settings2_Tab Tab - class-admin-settings-libraries-tab-ui.php.
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'BellPopup_Settings_Settings2_Tab', false ) ) :

	/**
	 * BellPopup_Settings_Settings2_Tab Class.
	 */
	class BellPopup_Settings_Settings2_Tab {
		...
		public function __construct() {
			...
			require_once BELLPOPUP_CLASS_DIR . 'class-settings-two-form.php';

			// Instantiate the class.
			$this->template = new BellPopup_Admin_UI_Template();
			$this->form     = new BellPopup_Settings2_Form();
...
// Instantiate the class.
$cm = new BellPopup_Settings_Settings2_Tab();
